...
class EasebuzzPaymentOrderCancelledModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $this->setTemplate('module:easebuzzpayment/views/templates/hook/displayPaymentCancelReturn.tpl');
    }
}
