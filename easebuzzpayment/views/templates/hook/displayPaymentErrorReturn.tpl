...
<div class="box" id="cancel_order_div">
    ...
    <div class="order-cancelled-image">
        <img src="{$module_dir}views/img/payment_failed.jpg" alt="{l s='Order Cancelled' mod='easebuzzpayment'}" />
    </div>

    <!-- Title -->
    <h1>{l s='Payment Failed' mod='easebuzzpayment'}</h1>

    <p>
        <strong class="dark">
            {l s='We’re sorry to inform you that your order placed on %s has been cancelled due to payment failure.' sprintf=[$shop_name] mod='easebuzzpayment'}
        </strong>
    </p>
    
    <!-- Message -->
    <p>{l s='Unfortunately, the payment for your order was unsuccessful. This could be due to various reasons such as insufficient funds, an expired card, or incorrect payment details. Please check your account for any pending transactions.' mod='easebuzzpayment'}</p>
    <p>{l s='If you believe this is an error, feel free to contact your bank or payment provider for further assistance.' mod='easebuzzpayment'}</p>
